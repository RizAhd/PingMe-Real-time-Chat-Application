...
function ChatApp() {
  ...
  return (
    // WebSocketProvider uses auth.userId (0 when not signed in)
      ...
      <ThemeProvider>
        <UserRegistrationProvider>
          <NavigationContainer>
            ...
            >
              {auth?.isLoading ? (
                // loading splash while auth is resolving
                <Stack.Screen
                  name="SplashScreen"
                ...
                // Signed in — main app
                <Stack.Group>
                  {/* HomeScreen here is actually HomeTabs (tab navigator) */}
                  <Stack.Screen
                    name="HomeScreen"
                    component={HomeTabs}
                    options={{ headerShown: false }}
